...
async function presupuestos({ filtro='todos', search='', offset=0 }={}) {
  ...
  document.getElementById('main-content').innerHTML = `
    ...
    <div class="search-box">
      ...
      <input type="text" placeholder="Buscar presupuesto..." value="${h(search)}" oninput="debounce('ppto',()=>presupuestos({filtro:'${hjs(filtro)}',search:this.value}))" class="form-input" style="padding-left:2.5rem">
    </div>
    <div class="tabs">
