...
function buildNav() {
  ...
  if (rol === 'admin' || rol === 'empleado' || rol === 'superadmin') {
    sidebarSections.push({ title: 'PRINCIPAL', items: [
      ...
      { id:'quickservice', label:'Servicio Rápido', icon:'<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>' },
  ...
  if (esAdmin()) {
    ...
    sidebarSections.push({ title: 'FINANZAS', items: [
      ...
      { id:'facturacion', label:'Facturas', icon:'<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/>' },
